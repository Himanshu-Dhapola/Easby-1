...
app.use(cors({ origin: "https://himanshu-dhapola-easby.vercel.app", methods: ['GET', 'POST', 'PATCH', 'PUT', 'DELETE', 'OPTIONS'], allowedHeaders: ['Origin', 'Content-Type', 'X-Auth-Token', 'Authorization'], credentials: true }));
